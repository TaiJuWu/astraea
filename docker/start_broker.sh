...
declare -r NODE_ID=${BROKER_PORT}
declare -r CONTAINER_NAME=${CONTAINER_NAME:-broker-$BROKER_PORT}
...
declare -r LOG4j2_YAML="/tmp/log4j2-${BROKER_PORT}.yaml"
declare -r IMAGE_NAME=${IMAGE_NAME:-"ghcr.io/${ACCOUNT}/astraea/broker:${KAFKA_VERSION}"}
